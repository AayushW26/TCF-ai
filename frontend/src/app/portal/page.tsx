...
import { FileCheck, CheckCircle, XCircle, Clock, AlertTriangle, Layers } from 'lucide-react';

export default function GstPortalDeskPage() {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center space-x-2 text-xs font-semibold text-sky-400 mb-1">
              ...
              <span>Official GST Portal Integration & IMS Desk</span>
            </div>
            <h1 className="text-2xl font-extrabold text-white">
              Invoice Management System (IMS) & GSTR-3B Auto-Draft
            </h1>
            <p className="text-xs text-slate-400 mt-1">
              Manage recipient invoice actions & verify GSTR-3B auto-drafted claims for trader: <strong className="text-slate-200">{activeTrader?.business_name || 'Shree Ganesh Traders'}</strong>
            </p>
          </div>
